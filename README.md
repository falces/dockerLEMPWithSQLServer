# Docker Compose LEMP Stack with SQLServer

This repository contains a little `docker-compose` configuration to start a `LEMP (Linux, Nginx, MySQL, PHP)` stack and SQL Server Express edition.
